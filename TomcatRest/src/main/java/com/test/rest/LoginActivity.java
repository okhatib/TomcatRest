...
public class LoginActivity extends Activity {
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            mAuthTask.execute(new String[] { secureBaseURL });
        }
    }
    ...
    public class UserLoginTask extends AsyncTask<String, Void, Boolean> {
        ...
        public Boolean verifyUserAccount(String urlPath) throws IOException
        {
            URL url = new URL(urlPath);

            HttpsURLConnection connection = (HttpsURLConnection)url.openConnection();
            String encode = mEmailView.getText().toString() + ":" + mPasswordView.getText().toString();
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                ed.putString("username", mEmailView.getText().toString());
